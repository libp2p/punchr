...
const (
	...
	HolePunchOutcome_HOLE_PUNCH_OUTCOME_CANCELLED HolePunchOutcome = 3
	// The hole punch was attempted several times but failed
	HolePunchOutcome_HOLE_PUNCH_OUTCOME_FAILED HolePunchOutcome = 4
	// The hole punch was performed and successful
	HolePunchOutcome_HOLE_PUNCH_OUTCOME_SUCCESS HolePunchOutcome = 5
)
...
var (
	HolePunchOutcome_name = map[int32]string{
		...
		3: "HOLE_PUNCH_OUTCOME_CANCELLED",
		4: "HOLE_PUNCH_OUTCOME_FAILED",
		5: "HOLE_PUNCH_OUTCOME_SUCCESS",
	}
...
const (
	...
	HolePunchAttemptOutcome_HOLE_PUNCH_ATTEMPT_DIRECT_DIAL HolePunchAttemptOutcome = 1
	// Can happen if, e.g., the stream was reset mid-flight
	HolePunchAttemptOutcome_HOLE_PUNCH_ATTEMPT_PROTOCOL_ERROR HolePunchAttemptOutcome = 2
	// The overall hole punch was cancelled by the user
	HolePunchAttemptOutcome_HOLE_PUNCH_ATTEMPT_CANCELLED HolePunchAttemptOutcome = 3
	// The /libp2p/dcutr stream was opened but the hole punch was not initiated in time
	HolePunchAttemptOutcome_HOLE_PUNCH_ATTEMPT_TIMEOUT HolePunchAttemptOutcome = 4
	// The hole punch was performed but has failed
	HolePunchAttemptOutcome_HOLE_PUNCH_ATTEMPT_FAILED HolePunchAttemptOutcome = 5
	// The hole punch was performed and was successful
	HolePunchAttemptOutcome_HOLE_PUNCH_ATTEMPT_SUCCESS HolePunchAttemptOutcome = 6
)
...
var (
	HolePunchAttemptOutcome_name = map[int32]string{
		...
		1: "HOLE_PUNCH_ATTEMPT_DIRECT_DIAL",
		2: "HOLE_PUNCH_ATTEMPT_PROTOCOL_ERROR",
		3: "HOLE_PUNCH_ATTEMPT_CANCELLED",
		4: "HOLE_PUNCH_ATTEMPT_TIMEOUT",
		5: "HOLE_PUNCH_ATTEMPT_FAILED",
		6: "HOLE_PUNCH_ATTEMPT_SUCCESS",
	}
...
type TrackHolePunchRequest struct {
	...
	Outcome *HolePunchOutcome `protobuf:"varint,9,req,name=outcome,enum=HolePunchOutcome" json:"outcome,omitempty"`
	// Unix timestamp in milliseconds of when the overall hole punch process ended
	EndedAt *uint64 `protobuf:"varint,10,req,name=ended_at,json=endedAt" json:"ended_at,omitempty"`
}
...
var file_punchr_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xc6, 0x03, 0x0a, 0x15, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x48, 0x6f, 0x6c, 0x65, 0x50,
	...
	,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x38, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x41, 0x64,
	0x64, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x13, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x64, 0x64, 0x72,
	...
	0x65, 0x12, 0x41, 0x0a, 0x0e, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x48, 0x6f, 0x6c, 0x65, 0x50, 0x75,
	0x6e, 0x63, 0x68, 0x12, 0x16, 0x2e, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x48, 0x6f, 0x6c, 0x65, 0x50,
	0x75, 0x6e, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x54, 0x72,
	0x61, 0x63, 0x6b, 0x48, 0x6f, 0x6c, 0x65, 0x50, 0x75, 0x6e, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x64, 0x65, 0x6e, 0x6e, 0x69, 0x73, 0x2d, 0x74, 0x72, 0x61, 0x2f, 0x70, 0x75,
	0x6e, 0x63, 0x68, 0x72, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62,
}
