...
var IPAddressWhere = struct {
	...
	ID:        whereHelperint64{field: "\"ip_addresses\".\"id\""},
...
var (
	...
	ipAddressColumnsWithoutDefault = []string{"address", "is_public", "updated_at", "created_at"}
	ipAddressColumnsWithDefault    = []string{"id", "country", "continent", "asn"}
